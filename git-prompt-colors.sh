override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="_LAST_COMMAND_INDICATOR_ ${Green}\\u@\\h${ResetColor}:${Blue}${PathShort}${ResetColor}"
...
reload_git_prompt_colors "Boris"